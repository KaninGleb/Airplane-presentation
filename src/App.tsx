...
function InfoIcon({ className, isHovered }: { className?: string; isHovered: boolean }) {
  const primaryColor = isHovered ? '#ffffff' : '#FF1616'
  const secondaryColor = isHovered ? '#FF1616' : '#ffffff'
